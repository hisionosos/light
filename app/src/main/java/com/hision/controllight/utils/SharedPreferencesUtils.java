...
import com.hision.controllight.MyApplication;
import java.io.File;
...
public class SharedPreferencesUtils {
    ...
    protected SharedPreferencesUtils() {
        mSharedPreferences = MyApplication.getContext().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
    ...
    public static void setParam(String key, Object value) {
        SharedPreferences sharedPreferences = MyApplication.getContext().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
