package com.hision.controllight.views.xrecycleview;
...
import static com.hision.controllight.views.xrecycleview.BaseRefreshHeader.STATE_DONE;
...
public class XRecyclerView extends RecyclerView {
    ...
    private int limitNumberToCallLoadMore = 0;
    ...
    public void setRefreshTimeVisible(boolean b){
        if (mRefreshHeader != null){
            mRefreshHeader.setRefreshTimeVisible(b);
        }
    }
